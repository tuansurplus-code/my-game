    ...
    <main className="page">
      ...
      <style jsx>{`
        *{box-sizing:border-box}
        ...
        .appearance-layout{display:grid;grid-template-columns:minmax(0,1fr) 390px;gap:22px;align-items:start;margin-top:24px}.card{background:rgba(255,255,255,.96);border:1px solid #e1e5e9;border-radius:17px;box-shadow:0 12px 35px rgba(26,34,46,.07)}
        ...
        @media(max-width:1050px){.appearance-layout{grid-template-columns:minmax(0,1fr) 340px}.tab{padding:10px 8px;gap:7px}.tab-icon{width:28px;height:28px;font-size:14px}.tab-copy strong{font-size:10px}.tab-copy small{font-size:7.5px}}
