...
export default function WheelAppearancePage() {
  ...
  async function loadSettings() {
    ...
    const { data, error } = await supabase
      .from("wheel_settings")
      .select(
        "id,title,subtitle,button_text,page_background_color,button_color,button_text_color,pointer_color,center_color,text_color,logo_url,font_family,animation_duration"
      )
      .eq("id", 1)
      .maybeSingle();
  ...
  function updateSetting<K extends keyof WheelSettings>(
    key: K,
  ...
  async function resetDefaults() {
    const confirmed = window.confirm(
      "Reset the wheel appearance settings to the default design?"
    );
  ...
  return (
    <main
      className="page"
      style={{ background: settings.page_background_color }}
    >
      <div className="topbar">
        <div>
          <div className="brand">SINGHAGIRI</div>
          <div className="brand-sub">SPIN & WIN ADMIN</div>
        </div>
      ...
      <div className="content">
        <div className="heading">
          <div>
            ...
            <p>Manage the customer-facing Spin & Win appearance.</p>
          </div>
        </div>
        ...
        <form onSubmit={saveSettings} className="layout">
          <section className="card settings-card">
            ...
            <label>
              ...
              />
              <small>Logo upload will be added in the next appearance stage.</small>
            </label>
            ...
            <ColorField
              ...
              onChange={(value) => updateSetting("page_background_color", value)}
            />

            <ColorField
              label="Button Color"
              value={settings.button_color}
              onChange={(value) => updateSetting("button_color", value)}
            />
            ...
            <ColorField
              ...
              onChange={(value) => updateSetting("pointer_color", value)}
            />

            <ColorField
              label="Wheel Center Color"
              value={settings.center_color}
              onChange={(value) => updateSetting("center_color", value)}
            />

            <ColorField
              label="Wheel Text Color"
            ...
            <label>
              Spin Animation Duration: {settings.animation_duration.toFixed(1)} seconds
              <input
                type="range"
                min="1"
                max="10"
                ...
                onChange={(e) =>
                  updateSetting("animation_duration", Number(e.target.value))
                }
              />
            </label>
          ...
          <section className="card preview-card">
            ...
            >
              ...
              <div className="mini-wheel">
                <div
                  ...
                  style={{ color: settings.pointer_color }}
                >▼</div>
                ...
                <div
                  ...
                  style={{ background: settings.center_color }}
                >
            ...
            <div className="preview-note">
              This preview shows the appearance settings. The actual prize wheel will use these settings after Stage 4B is connected.
            </div>
          </section>
        </form>
      </div>
