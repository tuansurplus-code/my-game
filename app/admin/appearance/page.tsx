      ...
      <aside className="preview-card">
        ...
        <div className="phone" style={{background:settings.page_background_color,fontFamily:settings.font_family}}>
          ...
          <div className="customer">
            ...
            <div className="wheel"><div className="pointer" style={{borderTopColor:settings.pointer_color}}/><div className="wheel-art">PRIZE WHEEL</div><div className="center" style={{background:settings.center_color}}>SPIN</div></div>
