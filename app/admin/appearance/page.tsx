        ...
        <div className="phone" style={{background:settings.page_background_color,fontFamily:settings.font_family}}>
          ...
          <div className="customer">
            ...
            <div className="wheel-preview">
              <div className="wheel-pointer" style={{borderTopColor:settings.pointer_color}}>
                <span className="pointer-dot" style={{background:settings.pointer_color}} />
              </div>
              <svg className="real-wheel" viewBox="0 0 360 360" role="img" aria-label="Spin and Win prize wheel">
                <circle cx="180" cy="180" r="174" fill="#ffffff"/>
                <circle cx="180" cy="180" r="165" fill="#111111"/>
                <path d="M180 15 A165 165 0 0 1 336.9 128.9 L180 180 Z" fill="#ed1c24"/>
                ...
                <line x1="180" y1="180" x2="82.9" y2="313.4" stroke="#fff" strokeWidth="4"/>
                <line x1="180" y1="180" x2="23.1" y2="128.9" stroke="#fff" strokeWidth="4"/>
                <circle cx="180" cy="180" r="165" fill="none" stroke="#111111" strokeWidth="8"/>
                <text x="180" y="70" textAnchor="middle" fill="#fff" fontSize="13" fontWeight="900">5% OFF</text>
                <text x="284" y="108" textAnchor="middle" fill="#fff" fontSize="13" fontWeight="900" transform="rotate(62 284 108)">15% OFF</text>
                <text x="276" y="254" textAnchor="middle" fill="#fff" fontSize="13" fontWeight="900" transform="rotate(145 276 254)">20% OFF</text>
                <text x="89" y="254" textAnchor="middle" fill="#fff" fontSize="11" fontWeight="900" transform="rotate(-145 89 254)">Rs. 1,000 OFF</text>
                <text x="76" y="108" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="900" transform="rotate(-62 76 108)">Try Again Later</text>
                <circle cx="180" cy="180" r="34" fill="#111"/>
                <circle cx="180" cy="180" r="28" fill="#241fe8" stroke="#fff" strokeWidth="4"/>
                <text x="180" y="176" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="900">SPIN</text>
                <text x="180" y="190" textAnchor="middle" fill="#fff" fontSize="8" fontWeight="900">&amp; WIN</text>
              </svg>
            </div>
