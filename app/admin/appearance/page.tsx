        ...
        <form onSubmit={saveSettings}>
          <div className="appearance-layout">
            ...
            <aside className="preview-column">
              <div className="preview-section-head"><div><div className="preview-kicker">PREVIEW</div><h2>Customer View</h2><p>Live preview of the Spin & Win page.</p></div><span className="live-badge"><i /> Live</span></div>
