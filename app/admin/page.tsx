...
export default function AdminDashboard() {
  ...
  const couponStatusDistribution =
    Array.from(
      history.reduce(
        (map, record) => {
          const status =
  ...
  return (
    <main className="admin-page">
                  ...
                  <div>
                    ...
                    <div className="overview-description">
                      {hasActiveHistoryFilters
                        ? `Filtered from ${history.length} records`
                        : "Latest 100 records"}
                    </div>
                  </div>
                </div>
            ...
            <>
              <div className="page-heading">
                <div>
                  ...
                  <p>
                    Monitor spin activity,
                    coupon usage and prize
                    distribution.
                  </p>
                </div>
              ...
              <div className="overview-header">
                <div>
                  ...
                  <p>
                    Current statistics based
                    on the latest 100 recorded
                    spins.
                  </p>
                </div>
              </div>
              ...
              <div className="statistics-grid">
                ...
                <div className="statistics-card">
                  ...
                  ) : couponStatusDistribution.length ===
                    0 ? (
                    <div className="statistics-empty">
              ...
              <div className="statistics-card recent-statistics-card">
                <div className="statistics-card-header">
                  <div>
                    <div className="eyebrow">
                      RECENT ACTIVITY
                ...
                0 ? (
                  ...
                  <div className="statistics-list">
                    {recentActivity.map(
                      (record) => (
                        <div
                          className="statistics-row recent-activity-row"
                          key={
                            record.id
                          }
                        >
      ...
      <style jsx>{`
        ...
        .recent-activity-main > div:first-child {
          display: flex;
          flex-direction: column;
          gap: 5px;
        }
        ...
        @media (max-width: 800px) {
          ...
          .statistics-card-header .refresh-button {
            width: 100%;
          }
